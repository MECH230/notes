...
::: {.historical-box}
[Historical Perspective: Frenet, Serret, and the Moving Basis]{.historical-title}

The unit vectors ${\bf e}_t, {\bf e}_n, {\bf e}_b$ carry the names of two French mathematicians who never worked together. Jean Frédéric Frenet first derived the formulas describing how this triad turns along a curve in his 1847 doctoral thesis at Toulouse, publishing only a summary in 1852. Joseph Alfred Serret arrived at the same relations independently and published them in full in 1851, and it is largely through his more widely circulated version that both the formulas and the triad came to carry both names.

The real subtlety of this basis is that $\{{\bf e}_t,{\bf e}_n,{\bf e}_b\}$ rotates as the particle moves along $\mathcal{C}$, even though the curve itself is fixed in space. Differentiating a vector expressed in a rotating basis introduces extra terms beyond the plain derivatives of its components -- the same idea that Gaspard-Gustave de Coriolis formalized in 1835 for observers in rotating reference frames. That same extra term reappears explicitly, under its own name, as the *Coriolis acceleration* when we revisit rotation later using cylindrical polar coordinates.
:::
...
{{< video https://youtu.be/OB13c0WlUSg title="A derivation of the Serret-Frenet Formulae" >}}
...
![MKB 02-090.](../figures/serret_frenet_triad/02-090.png){width=50%}

**3.** [MKB 02-091] *(ans. $\rho = 1709$ m)*

![MKB 02-091.](../figures/serret_frenet_triad/02-091.png){width=50%}
...
![MKB 02-097.](../figures/serret_frenet_triad/02-097.png){width=50%}
...
![MKB 02-199.](../figures/serret_frenet_triad/02-199.png){width=50%}

**7.** [03-040] Note the jump in normal force at the transition from straight to curved path. *(ans. (a) $R=1.177$ N; (b) $R=1.664$ N)*

![MKB 03-040.](../figures/serret_frenet_triad/03-040.png){width=50%}

**8.** [03-041] What does "weightless" mean? *(ans. $\rho=24\,000$ ft)*

![MKB 03-041.](../figures/serret_frenet_triad/03-041.png){width=50%}
...
![O'Reilly Primer, Exercise 3.1.](../figures/serret_frenet_triad/oor_3_1.png){width=70%}

**11.** [OOR 3.2]

![O'Reilly Primer, Exercise 3.2.](../figures/serret_frenet_triad/oor_3_2.png){width=70%}
