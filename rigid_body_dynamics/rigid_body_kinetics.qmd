...
::: {.historical-box}
[Historical Perspective: Leonhard Euler (1707--1783)]{.historical-title}

![Portrait by Emanuel Handmann, 1753 (Wikimedia Commons, public domain).](../figures/historical/leonhard_euler.jpg){width=35% fig-align="center"}
...
::: {.historical-box}
[Historical Perspective: Euler's Original Paper (1750)]{.historical-title}

::: {layout-ncol="2"}
![Opening page (archive.org, public domain).](../figures/historical/euler_1750_paper.jpg)

![The page stating the balance laws (archive.org, public domain).](../figures/historical/euler_1750_paper_equations.jpg)
:::
...
The total weight is ${\bf W} = \int_{\mathcal{B}}{\bf g}\,dm = {\bf g}\int_{\mathcal{B}}dm = m{\bf g}$, and its moment about $C$ is:
\begin{align}
...
\end{align}
The **angular impulse - angular momentum equations** are equivalently
\begin{align}
...
You can learn more about this [here](https://rotations.berkeley.edu/a-tumbling-t-handle-in-space/) and [here](https://rotations.berkeley.edu/a-book-tossed-in-the-air/).

https://www.youtube.com/watch?v=1VPfZ_XzisU&t=22s

{{< video https://www.youtube.com/watch?v=1VPfZ_XzisU&t=22s title="Veritasium: The Bizarre Behavior of Rotating Bodies" >}}
...
![MKB 06-029.](../figures/rigid_body_kinetics/problems/06-029.png){width=50%}

**2.** [MKB 06-035] *(ans. $R=3.57$ lb)*

![MKB 06-035.](../figures/rigid_body_kinetics/problems/06-035.png){width=50%}

{{< video https://youtu.be/gvBZyEq_bGo title="Solution – Problem 06/035 Nonzero products of inertia" >}}

**3.** [06-037] *(ans. $A=56.3$ N)*

![MKB 06-037.](../figures/rigid_body_kinetics/problems/06-037.png){width=50%}

**4.** [06-039] *(ans. (a) $\alpha=7.85$ rad/s$^2$ CCW, (b) $\alpha=6.28$ rad/s$^2$ CCW)*

![MKB 06-039.](../figures/rigid_body_kinetics/problems/06-039.png){width=50%}
...
![MKB 06-054.](../figures/rigid_body_kinetics/problems/06-054.png){width=50%}

**7.** [MKB 07-066] *Dynamic imbalance of a rotating shaft carrying two offset point masses.*

![MKB 07-066.](../figures/rigid_body_kinetics/problems/07-066.png){width=50%}
