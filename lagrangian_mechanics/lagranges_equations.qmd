...
\end{align}
If the forces are prescribed with Lagrange's prescription, then $\sum_{K=1}^n{\bf F}^K\cdot \frac{\partial {\bf r}^K}{\partial q^i}$ and $\sum_{K=1}^n{\bf F}_{nonc}^K\cdot \frac{\partial {\bf r}^K}{\partial q^i}$ reduce to $\sum_{K=1}^n{\bf F}_{appliedc}\cdot\frac{\partial {\bf r}^K}{\partial q^i}$ and $\sum_{K=1}^n{\bf F}_{applied, nconc}\cdot\frac{\partial {\bf r}^K}{\partial q^i}$ respectively, that is the applied forces and the nonconservative applied forces.
